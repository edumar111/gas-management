...
// GetNodeGasLimit is a free data retrieval call binding the contract method 0xdfa47470.
//
// Solidity: function getNodeGasLimit() view returns(uint256)
func (_Relay *RelayCaller) GetNodeGasLimit(opts *bind.CallOpts, from common.Address) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Relay.contract.Call(opts, out, "getNodeGasLimit", from)
	return *ret0, err
}
...
//
// Solidity: function getGasLimit() view returns(uint256)
func (_Relay *RelaySession) GetNodeGasLimit(from common.Address) (*big.Int, error) {
	return _Relay.Contract.GetNodeGasLimit(&_Relay.CallOpts, from)
}

// GetNodeGasLimit is a free data retrieval call binding the contract method 0xdfa47470.
//
// Solidity: function getGasLimit() view returns(uint256)
func (_Relay *RelayCallerSession) GetNodeGasLimit(from common.Address) (*big.Int, error) {
	return _Relay.Contract.GetNodeGasLimit(&_Relay.CallOpts, from)
}
